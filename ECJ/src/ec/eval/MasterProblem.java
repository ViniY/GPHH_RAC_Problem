 ...
 *
 ...
 <li><p>You can demo in non-blocking fashion to see if an individual is available, by calling
 ...
 <p><b>Parameters</b><br>
 <table>
 <tr><td valign=top><i>base.</i><tt>demo-info</tt><br>
...
public class MasterProblem extends Problem implements SimpleProblemForm, GroupedProblemForm 
    ...
    public static final String P_DEBUG_INFO = "demo-info";
